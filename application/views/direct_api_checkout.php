                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            <div class="input-group">
                                                <input class="form-control" id="card-number" type="text" name="card-number" placeholder="Card Number"><span class="input-group-addon"><i class="icon-credit-card"></i></span>
                                            </div>
                                        </div>
                                        <div class="form-group col-12">
                                            <div class="input-group">
